...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-adking-select', __webpack_require__(3));
  Vue.component('detail-adking-select', __webpack_require__(6));
  Vue.component('form-adking-select', __webpack_require__(9));
});
    ...
    methods: {
        ...
        updateOptions: function updateOptions() {
            ...
            if (this.parentValue != null && this.parentValue != "") {
                ...
                axios.get("/api/choices/" + this.parentValue).then(function (response) {

                    _this3.loaded = true;
                    _this3.options = response.data;
                    var optionValueExists = false;
                    console.log(_this3.options.length);
